...
for period_start, period_end in periods:
    ...
    positions = mds.fit_transform(df_filled.to_numpy())
...
df_deputy_distances.to_csv(os.path.join(processed_path, f"deputy_distances.csv"), index=False)

# Converter resultados gerais em DataFrame
df_results = pd.DataFrame(results)

# Salvar resultados gerais em CSV
df_results.to_csv(os.path.join(processed_path, f"average_mds_distances.csv"), index=False)

# Converter os resultados de stress em um DataFrame
df_stress = pd.DataFrame(stress_results)

# Salvar o DataFrame de stress em um arquivo CSV
# df_stress.to_csv(os.path.join(processed_path, f"stress_analysis_mds.csv"), index=False)
...
df_partido_distancias.to_csv(os.path.join(processed_path, f"partido_distancias.csv"), index=False)
